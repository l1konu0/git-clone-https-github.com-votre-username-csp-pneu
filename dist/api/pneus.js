...
async function handler(req, res) {
    ...
    try {
        if (req.method === 'GET') {
            ...
            const { data: pneus, error } = await supabase_1.supabase
                .from('pneus')
                .select('*')
            ...
            const { data: newPneu, error } = await supabase_1.supabase
                .from('pneus')
                .insert([{
                    marque,
                    modele,
            ...
            const { data: updatedPneu, error } = await supabase_1.supabase
                .from('pneus')
                .update({
                marque,
                modele,
